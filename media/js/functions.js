...
function showWarning(sElementId, sText){
    $(sElementId).text(sText);
    $(sElementId).removeClass("register_warning_hidden");
    $(sElementId).addClass("register_warning_shown");
}

function hideWarning(sElementId){
    $(sElementId).removeClass("register_warning_shown");
    $(sElementId).addClass("register_warning_hidden");
}
